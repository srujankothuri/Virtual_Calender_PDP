...
/**
 * Minimal formatting-clean smoke test for {@link CopyCommands}.
 * Verifies parser consumes expected syntax and emits a confirmation.
 */
public final class CopyCommandsParsingSmokeTest {
  ...
  @Test
  public void copyEventsOnDate_emitsConfirmation_smoke() {
